...
def freescaleFunction ( inputPathPy, outputPathPy, widthX, heightY ):
    ...
    output_img.save(outputPathPy, compress_level=1)[0]
    pyotherside.send('exchangeImage', outputPathPy)
    img.close()
    output_img.close()


def paddingImageFunction ( inputPathPy, outputPathPy, paddingRatio, paintColor ) :
    img = Image.open(inputPathPy)
...
def enhanceColorFunction ( inputPathPy, outputPathPy, factor ):
    img = Image.open(inputPathPy)
    if img.mode not in ('RGBA'):
        img = img.convert('RGBA')
    output_img = ImageEnhance.Color(img)
    output_img.enhance(factor).save(outputPathPy, compress_level=1)
    pyotherside.send('exchangeImage', outputPathPy)
    img.close()


def enhanceContrastFunction ( inputPathPy, outputPathPy, factor ):
    img = Image.open(inputPathPy)
    if img.mode not in ('RGBA'):
        img = img.convert('RGBA')
...
def enhanceBrightnessFunction ( inputPathPy, outputPathPy, factor ):
    img = Image.open(inputPathPy)
    if img.mode not in ('RGBA'):
        img = img.convert('RGBA')
...
def enhanceSharpnessFunction ( inputPathPy, outputPathPy, factor ):
    img = Image.open(inputPathPy)
    if img.mode not in ('RGBA'):
        img = img.convert('RGBA')
...
def grayscaleFunction ( inputPathPy, outputPathPy ):
    img = Image.open(inputPathPy)
    img = img.convert('RGBA')
    A = img.getchannel('A')
...
def blackWhiteFunction ( inputPathPy, outputPathPy ):
    img = Image.open(inputPathPy)
    img = img.convert('RGBA')
    A = img.getchannel('A')
...
def equalizeFunction ( inputPathPy, outputPathPy ):
    img = Image.open(inputPathPy)
    img = img.convert('RGBA')
    A = img.getchannel('A')
    img = img.convert('RGB')
...
def solarizeFunction ( inputPathPy, outputPathPy ):
    img = Image.open(inputPathPy)
    img = img.convert('RGBA')
    A = img.getchannel('A')
    img = img.convert('RGB')
...
def invertFunction ( inputPathPy, outputPathPy ):
    img = Image.open(inputPathPy)
    img = img.convert('RGBA')
    A = img.getchannel('A')
    img = img.convert('RGB')
...
def autocontrastFunction ( inputPathPy, outputPathPy ):
    img = Image.open(inputPathPy)
    img = img.convert('RGBA')
    A = img.getchannel('A')
    img = img.convert('RGB')
...
def blurFunction ( inputPathPy, outputPathPy, factor ):
    img = Image.open(inputPathPy)
    img = img.convert('RGBA')
...
def unsharpmaskFunction ( inputPathPy, outputPathPy, radiusMask, percentMask, thresholdMask ):
    img = Image.open(inputPathPy)
    img = img.convert('RGBA')
...
def findedgesFunction ( inputPathPy, outputPathPy, fileTargetType ):
    img = Image.open(inputPathPy)
...
def contourFunction ( inputPathPy, outputPathPy ):
    img = Image.open(inputPathPy)
    img = img.convert('RGBA')
...
def embossFunction ( inputPathPy, outputPathPy ):
    img = Image.open(inputPathPy)
    img = img.convert('RGBA')
...
def modedrawingFunction ( inputPathPy, outputPathPy ):
    img = Image.open(inputPathPy)
    output_img = img.filter(ImageFilter.ModeFilter(size=9))
    output_img.save(outputPathPy, compress_level=1)
    pyotherside.send('exchangeImage', outputPathPy)
    img.close()
    output_img.close()
...
def edgeenhanceFunction ( inputPathPy, outputPathPy ):
    img = Image.open(inputPathPy)
    img = img.convert('RGBA')
...
def make_linear_ramp(white):
    ...
    return ramp
def sepiaFunction ( inputPathPy, outputPathPy ):
...
def stretchContrastFunction ( inputPathPy, outputPathPy ):
...
def posterizeFunction ( inputPathPy, outputPathPy ):
    img = Image.open(inputPathPy)
    img = img.convert('RGBA')
    A = img.getchannel('A')
    img = img.convert('RGB')
...
def colorToAlphaFunction ( inputPathPy, outputPathPy, targetColor2Alpha, targetColorTolerance ) :
...
def blurImageSidesFunctiom ( inputPathPy, outputPathPy, radiusEdgeBlur, paintColor ):
    img = Image.open(inputPathPy)
...
def tintWithColorFunction ( inputPathPy, outputPathPy, tint_color, factorBrightness ):
    img = Image.open(inputPathPy)
    img = img.convert('RGBA')
...
def miniatureFocusFunction ( inputPathPy, outputPathPy, alphaMaskPath, radiusEdgeBlur, enhanceColorFaktor, enhanceContrastFaktor, addExtraBlurAroundPath ) :
...
def smoothSurfaceFunction ( inputPathPy, outputPathPy, smoothingStrength ):
    img = Image.open(inputPathPy)
    if img.mode not in ('RGBA'):
        img = img.convert('RGBA')
...
def quantizeFunction ( inputPathPy, outputPathPy, colorsAmount ):
    img = Image.open(inputPathPy)
    if img.mode not in ('RGBA'):
        img = img.convert('RGBA')
...
def addAlphaFunction ( inputPathPy, outputPathPy, percentAlpha ):
    img = Image.open(inputPathPy)
...
def extractColorFunction ( inputPathPy, outputPathPy, colorExtract ):
    img = Image.open(inputPathPy)
    img = img.convert('RGBA')
    data = img.getdata()
...
def extractChannelFunction ( inputPathPy, outputPathPy, channelExtract ):
    img = Image.open(inputPathPy)
    img = img.convert('RGBA')
...
def moodsMiddleStepFunction( effectName ):
    pyotherside.send('startMoodsFunctionFromPy', effectName )


def gothamFilterFunction( inputPathPy, outputPathPy, sharpenFactor ):
...
def cremaFilterFunction ( inputPathPy, outputPathPy, colorFactor, contrastFactor ):
    img = Image.open(inputPathPy)
    img = img.convert('RGBA')
    A = img.getchannel('A')
    img = img.convert('RGB')
...
def junoFilterFunction( inputPathPy, outputPathPy, brightnessFactor, saturationValue ):
    img = Image.open(inputPathPy)
    img = img.convert('RGBA')
...
def kelvinFilterFunction( inputPathPy, outputPathPy ):
...
def xproiiFilterFunction( inputPathPy, outputPathPy ):
...
def amaroFilterFunction( inputPathPy, outputPathPy ):
...
def mayfairFilterFunction( inputPathPy, outputPathPy ):
...
def nineteen77FilterFunction( inputPathPy, outputPathPy ):
...
def lofiFilterFunction( inputPathPy, outputPathPy ):
...
def hudsonFilterFunction( inputPathPy, outputPathPy ):
...
def redtealFilterFunction( inputPathPy, outputPathPy, colorFactor ):
    img = Image.open(inputPathPy)
    img = img.convert('RGBA')
    A = img.getchannel('A')
    R = img.getchannel('R')
...
def coalFilterFunction( inputPathPy, outputPathPy, blurRadius ):
...
def nashvilleFilterFunction( inputPathPy, outputPathPy ):
...
def hefeFilterFunction( inputPathPy, outputPathPy ):
...
def sierraFilterFunction( inputPathPy, outputPathPy ):
...
def apply3dLUTcubeFile (inputPathPy, cubeFilePath, lut3dType, outputPathPy):
...
def paintTextRegionFunction ( inputPathPy, outputPathPy, rectX, rectY, scaleFactor, paintColor, paintText, paintTextSize, paintTextFontNr, paintTextFontStyleNr, paintTextAngle, paintTextDirection, customFontFilePath ):
    img = Image.open(inputPathPy)
    if img.mode not in ('RGBA'):
        img = img.convert('RGBA')
    rectX_real = int(rectX * scaleFactor)
    ...
    img_txt = Image.new('RGBA', ftn.getsize(paintText))
    ...
    baseWidth, baseHeight = draw_text.textsize("h", ftn)
    if 0 < int(paintTextAngle) <= 90:
        adjustedY = int(rectY_real - img_txt_rotatedHeight + ((img_txt_oldHeight-baseHeight) * math.cos(math.radians( int(paintTextAngle)) ) ))
        adjustedX = int(rectX_real - (img_txt_oldHeight * math.sin( math.radians( int(paintTextAngle) ) ) ))
    elif 0 > int(paintTextAngle) >= -90:
        adjustedY = int(rectY_real - (baseHeight * (math.cos(math.radians( abs(int(paintTextAngle)) ) ) ) ))
        adjustedX = int(rectX_real - ((img_txt_oldHeight - baseHeight) * math.sin( math.radians( abs(int(paintTextAngle)) ) ) ))
    else: # paintTextAngle = 0
        adjustedY = rectY_real - baseHeight
        adjustedX = rectX_real
    if "center" in paintTextDirection:
        adjustedX = int(adjustedX - ( img_txt_oldWidth/2 * math.cos(math.radians( int(paintTextAngle)) )) )
        adjustedY = int(adjustedY + ( img_txt_oldWidth/2 * math.sin(math.radians( int(paintTextAngle)) )) )
    elif "right" in paintTextDirection:
        adjustedX = int(adjustedX - ( img_txt_oldWidth * math.cos(math.radians( int(paintTextAngle)) )) )
        adjustedY = int(adjustedY + ( img_txt_oldWidth * math.sin(math.radians( int(paintTextAngle)) )) )
